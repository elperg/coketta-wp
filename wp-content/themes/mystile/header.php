...
<div id="wrapper">
	...
	<header id="header" class="col-full">
	    ...
	    <hgroup>
	    	 ...
	    	 <?php
			    $logo = esc_url( get_template_directory_uri() . '/uploads/2016/05/coketta-logo-new-2.gif' );
			...
			<?php if ( ! isset( $woo_options['woo_texttitle'] ) || $woo_options['woo_texttitle'] != 'true' ) { ?>
			    <a id="logo" href="<?php echo esc_url( home_url( '/' ) ); ?>" title="<?php esc_attr( get_bloginfo( 'description' ) ); ?>">
			    	<img src="http://www.coketta.com/wp-content/uploads/2016/05/coketta-logo-new-2.gif" alt="<?php echo esc_attr( get_bloginfo( 'name' ) ); ?>" />
			    </a>
		    <?php } ?>
